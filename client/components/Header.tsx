    ...
    <View className='flex-row items-center justify-between px-4 py-3 bg-white'>
      ...
      <View className='flex-row items-center flex-1'>
        ...
        {showLogo ? (
          ...
          <Text className='text-lg font-bold text-primary text-center flex-1'>{title}</Text>
          )}
          ...
          {showCart && (
            <TouchableOpacity onPress={()=> router.push('/(tabs)/cart')}>
              <View className='relative'>
                ...
                <View className='-top-1 -right-1 bg-accent w-4 h-4 rounded-full absolute items-center justify-center'>
